...
from ..exceptions import AdapterConnectionError, AdapterExecutionError, AdapterTimeoutError
...
class PostgreSQLAdapter(DBAdapter):
    ...
    def connect(self, host: str = 'localhost', port: int = None) -> None:
        ...
        try:
            ...
            raise AdapterConnectionError(f"PostgreSQL connection failed: {str(e)}")
